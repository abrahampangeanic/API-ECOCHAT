...
class CollectionService {
  ...
  async create(data) {
    const assistant = await models.Collection.create(data);
    return assistant;
  }

  async findByInstance(instanceId) {
    const assistant = await models.Collection.findAll({
  ...
  async findByInstanceAndId(instanceId, id) {
    const assistant = await models.Collection.findOne({
  ...
  async findOne(id) {
    const assistant = await models.Collection.findByPk(id );
