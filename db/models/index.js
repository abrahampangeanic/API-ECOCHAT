...
const {
  AssistantSkill,
  AssistantSkillSchema,
} = require('./assistant-skill.model');
...
} = require('./assistant-message.model');
...
function setupModels(sequelize) {
  ...
  AssistantPrompt.init(
    AssistantPromptSchema,
    AssistantPrompt.config(sequelize)
  );
  Prompt.init(PromptSchema, Prompt.config(sequelize));
  AssistantCollection.init(
    AssistantCollectionSchema,
    AssistantCollection.config(sequelize)
  );
  Collection.init(CollectionSchema, Collection.config(sequelize));
  CollectionSource.init(
    CollectionSourceSchema,
    CollectionSource.config(sequelize)
  );
  ...
  AssistantMessage.init(
    AssistantMessageSchema,
    AssistantMessage.config(sequelize)
  );
